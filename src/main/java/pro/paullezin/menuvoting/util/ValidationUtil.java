package pro.paullezin.menuvoting.util;

import pro.paullezin.menuvoting.error.IllegalRequestDataException;
import pro.paullezin.menuvoting.model.BaseEntity;
